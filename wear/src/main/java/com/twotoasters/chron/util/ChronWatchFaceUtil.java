package com.twotoasters.chron.util;
...
public final class ChronWatchFaceUtil {
    private static final String TAG = "DigitalWatchFaceUtil";

    /**
     * The {@link com.google.android.gms.wearable.DataMap} key for {@link ChronWatchFaceService} background color name. The color name
     * must be a {@link String} recognized by {@link android.graphics.Color#parseColor}.
     */
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    /**
     * The {@link com.google.android.gms.wearable.DataMap} key for {@link ChronWatchFaceService} hour digits color name. The color name
     * must be a {@link String} recognized by {@link android.graphics.Color#parseColor}.
     */
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    /**
     * The {@link com.google.android.gms.wearable.DataMap} key for {@link ChronWatchFaceService} minute digits color name. The color name
     * must be a {@link String} recognized by {@link android.graphics.Color#parseColor}.
     */
    public static final String KEY_MINUTES_COLOR = "MINUTES_COLOR";

    /**
     * The {@link com.google.android.gms.wearable.DataMap} key for {@link ChronWatchFaceService} second digits color name. The color name
     * must be a {@link String} recognized by {@link android.graphics.Color#parseColor}.
     */
    public static final String KEY_SECONDS_COLOR = "SECONDS_COLOR";

    /**
     * The path for the {@link com.google.android.gms.wearable.DataItem} containing {@link ChronWatchFaceService} configuration.
     */
     ...
     * {@link ChronWatchFaceService}.
     */
    public interface FetchConfigDataMapCallback {
        /**
         * Callback invoked with the current config {@link com.google.android.gms.wearable.DataMap} for {@link ChronWatchFaceService}.
         */
    ...
    /**
     * Asynchronously fetches the current config {@link com.google.android.gms.wearable.DataMap} for {@link ChronWatchFaceService} and
                ...
                new ResultCallback<GetLocalNodeResult>() {
                    ...
                    public void onResult(NodeApi.GetLocalNodeResult getLocalNodeResult) {
                        ...
                        Uri uri = new Uri.Builder()
                                .scheme("wear")
                                .path(ChronWatchFaceUtil.PATH_WITH_FEATURE)
                                .authority(localNode)
                                .build();
    ...
    public static void overwriteKeysInConfigDataMap(final GoogleApiClient googleApiClient,
        ...
        ChronWatchFaceUtil.fetchConfigDataMap(googleApiClient,
                new ChronWatchFaceUtil.FetchConfigDataMapCallback() {
                    @Override
                    public void onConfigDataMapFetched(DataMap currentConfig) {
                        DataMap overwrittenConfig = new DataMap();
                        overwrittenConfig.putAll(currentConfig);
                        overwrittenConfig.putAll(configKeysToOverwrite);
                        ChronWatchFaceUtil.putConfigDataItem(googleApiClient, overwrittenConfig);
                    }
                }
        );
    }
